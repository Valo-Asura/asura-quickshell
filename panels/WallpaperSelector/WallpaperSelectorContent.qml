            ...
            Item {
                ...
                RowLayout {
                        ...
                        RowLayout {
                            ...
                            TextInput {
                                ...
                                onTextChanged: {
                                    ...
                                    } else if (!mainSelector.wallhavenMode) {
                    ...
                    Item {
                        ...
                        visible: !mainSelector.wallhavenMode && !mainSelector.liveMode
                        ...
                        ScrollView {
                            ...
                            Column {
                                ...
                                RippleButton {
                                    ...
                                    enabled: GlobalStates.wallpaperSelectorTarget === "desktop" && !GameMode.active
                                    opacity: enabled ? (WallpaperEngineService.isInstalled ? 1 : 0.65) : 0.4
                                ...
                                Repeater {
                                    ...
                                    delegate: RippleButton {
                                        ...
                                        readonly property bool isActive: !mainSelector.wallhavenMode && !mainSelector.favMode && !mainSelector.liveMode && mainSelector.normalizePath(Wallpapers.directory) === mainSelector.normalizePath(modelData.path)
                                ...
                                Repeater {
                                    ...
                                    delegate: RippleButton {
                                        ...
                                        readonly property bool isActive: !mainSelector.wallhavenMode && !mainSelector.favMode && !mainSelector.liveMode && mainSelector.normalizePath(Wallpapers.directory) === mainSelector.normalizePath(model.path)
                ...
                Rectangle {
                    ...
                    GridView {
                            ...
                            ColumnLayout {
                                ...
                                Item {
                                    ...
                                    Rectangle {
                                        ...
                                        ThumbnailImage {
                                            anchors.fill: parent
                                            sourcePath: (delegateRoot.inWallhavenMode || delegateRoot.inLiveMode) ? "" : currentFilePath
                                            visible: sourcePath !== ""
                                        }
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                ...
                                                } else if (!delegateRoot.inWallhavenMode) {
                                                    if (currentFilePath !== "") {
                        ...
                        ColumnLayout {
                            ...
                            MaterialSymbol {
                                visible: (mainSelector.wallhavenMode && WallhavenService.loading) || (mainSelector.liveMode && WallpaperEngineService.loading)
                            ...
                            StyledText {
                                ...
                                color: (WallhavenService.errorMessage !== "" || WallpaperEngineService.errorMessage !== "") ? Appearance.m3colors.m3error : Appearance.colors.colSubtext
                                Layout.alignment: Qt.AlignHCenter
                            }
                        }
                    }
