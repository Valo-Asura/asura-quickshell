...
FocusScope {
    ...
    HoverHandler {
        enabled: GlobalStates.quickActionsOpen
        onHoveredChanged: GlobalStates.setHoverContent("quickActions", hovered)
    }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            visible: root.focus && root.highlightReady
